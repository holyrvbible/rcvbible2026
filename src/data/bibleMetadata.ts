...
export function isValidBkAbbr(maybeAbbr: string): maybeAbbr is BkAbbr {
  if (maybeAbbr in BkAbbrNum) {
    return true;
  }
  return false;
}

export const BkOneChapterOnly = new Set<BkAbbr>([
  "Oba",
  "Phm",
  "2Jo",
  "3Jo",
...
export const BkChapterNumVerses = [
  [
